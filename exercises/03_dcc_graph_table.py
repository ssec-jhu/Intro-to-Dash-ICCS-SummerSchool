...
df = pd.DataFrame({
    "research_software_engineer": [
        ...
        "Femi", "Greta", "Hassan", "Isla", "Jun",
        "Kofi", "Lena", "Miguel", "Noor", "Oscar",
    ],
    "country": [
        "UK", "USA", "Mexico", "Germany", "Spain",
        "Nigeria", "Sweden", "Egypt", "Scotland", "South Korea",
        "Ghana", "Norway", "Brazil", "Pakistan", "Argentina",
    ],
    "coffees_per_day": [3, 1, 5, 2, 4, 0, 6, 2, 4, 1, 3, 7, 4, 2, 5],
    "lines_of_code": [120, 85, 310, 95, 250, 60, 420, 110, 275, 70, 190, 500, 220, 130, 350],
    "bugs_introduced": [12, 5, 42, 8, 30, 3, 55, 9, 28, 4, 15, 61, 25, 11, 38],
    "workshop_rating": [5, 4, 5, 3, 4, 5, 5, 4, 3, 5, 4, 5, 4, 5, 3],
    "favourite_snack": [
        "Biscuits", "Chips", "Tacos", "Pretzels", "Churros",
        "Puff Puff", "Kanelbullar", "Koshari", "Shortbread", "Tteok",
        "Kelewele", "Lefse", "Pão de queijo", "Samosa", "Empanadas",
    ],
})
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.P("Below you'll find two charts and a data table — all built from "
        ...
        html.P("dcc.Graph renders interactive Plotly figures. "
               "Hover over points to see details, zoom, pan, or click legend items to toggle traces."),
        html.A("Graph docs", href="https://dash.plotly.com/dash-core-components/graph", target="_blank"),
        ...
        html.P("The same dcc.Graph component can display any Plotly figure — "
        ...
        html.P("DataTable displays tabular data with built-in sorting, filtering, and pagination."),
        html.A("DataTable docs", href="https://dash.plotly.com/datatable", target="_blank"),
        dash_table.DataTable(
